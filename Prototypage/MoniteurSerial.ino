...
///<summary> detecte les commandes d'entrées dans le moniteur serie et lance les procedures corespondantes </summary>
void SerialRead()
{
...
// Affiche la mesure de poids des 4 capteurs
 ...
 // Affiche la mesure des parametres de poids
      else if (sLectureSerie.equals("poids") || sLectureSerie.equals("POIDS"))
        {  
          vTaskDelay(1);
          Serial.println("A définir ulterieurement");
          Serial.println(sLectureSerie + " OK"); Serial.println(">");
        }          
...
// Affiche l'adresse IP  
      else if (sLectureSerie.equals("ip") || sLectureSerie.equals("IP"))
        {
            ...
            Serial.print("  Statut: ");Serial.println( WL_CONNECTED);
            Serial.println(sLectureSerie + " OK"); Serial.println(">");
        }   
